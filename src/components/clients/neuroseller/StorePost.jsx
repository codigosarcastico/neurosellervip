...
import BackgroundImg from "../../../assets/img/banners/neuroseller.jpg";
import AvatarImg from "../../../assets/img/avatars/neuroseller.jpg";
    ...
    <Paper className={classes.paper} elevation={3} variant="outlined">
      <Card className={classes.paperCard}>
        <CardActions className={classes.actionsHeader}>
          ...
          <IconButton>
          <Tooltip title="VIP FUNDADOR" aria-label="add"> 
      ...
      <CardContent>
        <Typography variant="body1" color="initial" paragraph>
          ...
          assumenda facere vitae iure dolore culpa velit error. Consectetur
          delectus vel laboriosam repellendus esse, excepturi blanditiis est
          dolorem sunt placeat voluptatibus possimus omnis id, aliquam provident
          iure minima. Architecto autem tempora hic suscipit sit? Assumenda
          dicta doloribus harum vel voluptatum cupiditate.
        </Typography>
          ...
          <Grid item xs={12} sm={6}>
            <List className={classes.listInfo}>
              ...
              <ListItem>
                ...
                <ListItemText
                  primary="Ubicacion"
                  secondary="Sector, Calle Parroquia"
                />
              </ListItem>
              ...
              <ListItem>
                ...
                <ListItemText primary="Movil" secondary="+58 12434 224 12" />
              </ListItem>
