...
import BackgroundImg from "../../../assets/img/banners/BannerMilic.jpg";
import AvatarImg from "../../../assets/img/avatars/AvatarMilic.jpg";
    ...
    <Paper className={classes.paper} elevation={3} variant="outlined"> 
      ...
      <Card className={classes.paperCard}>
        <CardActions className={classes.actionsHeader}>
          ...
          <IconButton>
            <Tooltip title="Milicremosito es VIP FUNDADOR" aria-label="add">
        ...
        <CardMedia src="#" title="Milicremositos" className={classes.media} />
        ...
        <CardActions>
          ...
          <Box>
            <Box display="flex" flexDirection="row" alignItems="center">
              <Tooltip title="Milicremositos es VIP FUNDADOR" aria-label="add">
        ...
        <CardActions>
          <Button
            ...
            href="https://wa.me/584248411225"
          >
            {" "}
            Contactar con Milicremositos
          </Button>
        </CardActions>
      </Card>
      ...
      <CardContent>
        <Typography variant="body1" color="initial" paragraph>
          Hola soy Milagros, creadora de la marca de helados Milicremositos. Te
          invito a contactarme y hacer tu pedido de mis mejores y mas deliciosos
          helados, presiona el boton para comunicarte directamente a mi WhatsApp
          o sigueme en mi cuenta Instagram
        </Typography>
          ...
          <Grid item xs={12} sm={6}>
            <List className={classes.listInfo}>
              ...
              <ListItem>
                ...
                <ListItemText
                  primary="Ubicacion"
                  secondary="El tigre, Estado Anzoategui"
                />
              </ListItem>
              ...
              <ListItem>
                ...
                <ListItemText primary="Movil" secondary="+58 424 8411225" />
              </ListItem>
          ...
          <Grid item xs={12} sm={6}>
            <List className={classes.listInfo}>
              ...
              <ListItem>
                ...
                <ListItemText primary="Instagram" secondary="@milicremositos" />
              </ListItem>
              {/* 
              <ListItem>
                <ListItemAvatar>
